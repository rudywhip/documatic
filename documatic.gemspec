Gem::Specification.new do |s|
  ...
  s.name        = 'documatic'
  s.version     = '0.3.0'
  s.summary     = 'An OpenDocument extension for Ruby Reports (Ruport).'
  ...
  s.date              = %q{2016-12-22}
  s.homepage          = 'https://github.com/rudywhip/documatic'
  s.authors           = 'original documatic authors + Alan Da Costa + Rudy Wiley'
